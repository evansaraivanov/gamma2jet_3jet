...
for i in t1:
	if i.pass_HLT_j400 == 1 :#and i.j1_is_truth_jet and i.j2_is_truth_jet:
		if i.j1_pT > 400 and i.j1_pT < 2000 and i.j2_pT/i.j2_pT < 1.5 and i.j3_pT > 20 and abs(i.j1_eta) < 2.1 and abs(i.j2_eta) < 2.1 and abs(i.j3_eta) < 2.1:
...
foutput = TFile("/eos/user/e/esaraiva/Gamma2jet/trijet-sherpa-py.root","recreate")

...
f2 = TFile("../root-files/gamma2jet_"+mcvar+"_py.root")
...
if mcvar == "sherpa": myText(0.48,0.72,'#bf{#scale[1.2]{Leading Jet p_{T} Spectrum, Sherpa}}')
if mcvar == "pythia": myText(0.48,0.72,'#bf{#scale[1.2]{Leading Jet p_{T} Spectrum, Pythia}}')

c.Print("pt-"+mcvar+".pdf")
